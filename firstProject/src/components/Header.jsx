    ...
    <div className="container mx-auto">
      <header>
        ...
        <div className="flex flex-col items-center flex-wrap md:flex-nowrap text-center px-3 ">
          <h1 className=" mb-3 font-bold text-6xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500  bg-clip-text text-transparent animate-bounce">React Essentials</h1>
